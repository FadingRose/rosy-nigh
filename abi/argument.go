...
func (arg Argument) IsSame(other Argument) bool {
	return arg.Name == other.Name && arg.Type.IsSame(other.Type)
}

func (args Arguments) IsSame(other Arguments) bool {
	if len(args) != len(other) {
		return false
	}
	for i, arg := range args {
		if arg.Name != other[i].Name || !arg.Type.IsSame(other[i].Type) {
			return false
		}
	}
	return true
...
func (args Arguments) String() string {
	...
	for _, arg := range args {
		ret = append(ret, arg.Name+":"+arg.Type.String())
	}
